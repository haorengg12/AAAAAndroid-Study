package com.example.kkcc.materialtest;
...
public class FruitActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "onCreate1: " + fruitName);
        int fruitImageId = intent.getIntExtra(FRUIT_IMAGE_ID, 0);
        Log.d(TAG, "onCreate2: " + fruitImageId);
    ...
    private String generateFruitContext(String fruiytName) {
        StringBuilder fruitContent = new StringBuilder();
        for (int i = 0; i < 500; i++) {
            fruitContent.append(fruiytName);
        }
